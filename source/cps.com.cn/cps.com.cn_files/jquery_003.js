	...
	$.fn.cpsSlide2 = function(options) {  
		...
		this.each(
			function () { 
				...
				var slideImg = $this.find(".contentWrap"); //获取焦点图 图片列表容器对
				...
				*/
				...
				function showPics(index) { //普通切换
					...
					$this.find('.circle-wrap').find("i").removeClass("current").eq(index).addClass("current"); //为当前的按钮切换到选中的效果
