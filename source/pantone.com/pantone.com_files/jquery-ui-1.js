...
(function ($) {
    ...
    $.alerts = {
        ...
        _show: function (title, msg, value, type, callback) {
            ...
            switch (type) {
                case 'alert':
                    $("#popup_message").after('<div id="popup_panel"> <a href="javascript:void(0)" id="popup_ok" class="ui-btn ui-btn-corner-all ui-btn-icon-left ui-shadow ui-btn-up-b"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">' + $.alerts.okButton + '</span><span class="ui-icon ui-icon-check ui-icon-shadow"></span></span></a></div>');
                    $("#popup_ok").click(function () {
                        $.alerts._hide();
                        callback(true);
                    });
                    $("#popup_ok").attr('tabIndex', 0).bind('focus', function () {
                        $(this).addClass('ui-btn-active').bind('blur', function () {
                    ...
                    $("#popup_ok").css({ outline: 'none' }).focus();

                    break;
                case 'confirm':
                    $("#popup_message").after('<div id="popup_panel"><a href="javascript:void(0)" id="popup_ok" class="ui-btn ui-btn-inline ui-btn-corner-all ui-mini ui-btn-icon-left ui-shadow ui-btn-up-b"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">' + $.alerts.YesButton + '</span><span class="ui-icon ui-icon-check ui-icon-shadow"></span></span></a><a href="javascript:void(0)" id="popup_cancel" class="ui-btn ui-btn-inline ui-btn-corner-all ui-mini ui-btn-icon-left ui-shadow ui-btn-up-b"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">' + $.alerts.cancelButton + '</span><span class="ui-icon ui-icon-delete ui-icon-shadow"></span></span></a></div>');
                    $("#popup_ok").click(function () {
                        $.alerts._hide();
                    ...
                    $("#popup_cancel").attr('tabIndex', 0).bind('focus', function () {
                        $(this).addClass('ui-btn-active').bind('blur', function () {
                            $(this).removeClass('ui-btn-active')
                        });
                    });
